      ...
      <div className="grid-container">
        ...
        <div>
          <Card className="profile-card">
            ...
            <p></p>
            <p>
              Loan must be paid back fully (with interest) in 6 monthly
              instalments. If you miss a repayment, it will be deducted from
              your salary.
            </p>
        ...
        <div>
          <Card className="profile-card">
            ...
            <p>
              Please note we may run checks to ensure that the loan is being
        ...
        <div>
          <Card className="profile-card">
            ...
            <p>
              To improve the interest rate, loan size, etc. that is available to
              you, you should bring <b>at least</b> one guarantor from inside
              the company.{" "}
            </p>
            ...
            <p>
              ...
              will guarantee for your loan. We will cross-check this information
              with them.
            </p>
            <p>This question is required.*</p>
        ...
        <div>
          <Card className="">
            ...
            <p>
              The sooner you do this, the sooner we can process your
              application.
            </p>
        ...
        <div>
          <Card>
            ...
            <p>
              I understand that if I am unable to repay any instalment for any
