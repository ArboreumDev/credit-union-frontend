  ...
  constructor() {
    this.data = {
      introSection: {
        ...
        desc:
          "Finance is complex enough. People and businesses deserve easy, straightforward products that actually work. Arboreum makes it super easy for anyone to borrow, invest and make payments. No excuses.",
        storeLink: {
          android:
      ...
      listSection: [
        {
          ...
          desc:
            "Get simple and easy access to funds. We all need to take a little credit for our hard work sometimes.",
        ...
        },
        {
          ...
          desc:
            "Invest the smart way on Arboreum Notes. Get access to our loan book and see exactly how your investment is used and your accrued interest.",
      ...
      mainSection: [
        ...
        },
        {
          ...
          desc:
            "Instant loans shouldn't be a luxury, Arboreum has credit solutions for the everyday person –– Whether you are a business, or an individual, we are determined to make credit work for you. No excuses. You are killing it, all you need is sufficient funds and we have got it.",
