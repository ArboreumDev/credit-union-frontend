...
export type ResetDbMutation = { __typename?: "mutation_root" } & {
  delete_transactions?: Maybe<
    { __typename?: "transactions_mutation_response" } & Pick<
...
export type GetTransactionHistoryQuery = { __typename?: "query_root" } & {
  transactions: Array<
    { __typename?: "transactions" } & Pick<
      Transactions,
...
export type GetTransactionQuery = { __typename?: "query_root" } & {
...
export const UpdateBalanceWithTransactionDocument = gql`
  mutation UpdateBalanceWithTransaction(
    $userId: uuid!
    $delta: float8!
    $tx: transactions_insert_input!
  ) {
...
export const UpdateTransactionStatusDocument = gql`
  mutation UpdateTransactionStatus(
    ...
    update_transactions_by_pk(
      pk_columns: { tx_nonce: $txNonce }
      _set: { status: $txStatus }
    ) {
      description
      loan_id
      user_id
...
export function getSdk(
  ...
  return {
    ...
    UpdateBalanceWithTransaction(
      variables: UpdateBalanceWithTransactionMutationVariables
    ): Promise<UpdateBalanceWithTransactionMutation> {
      return withWrapper(() =>
        client.request<UpdateBalanceWithTransactionMutation>(
          print(UpdateBalanceWithTransactionDocument),
          variables
        )
      )
    },
    ...
    ): Promise<GetTransactionHistoryQuery> {
      return withWrapper(() =>
        client.request<GetTransactionHistoryQuery>(
          print(GetTransactionHistoryDocument),
          variables
        )
      )
    },
    ...
    UpdateTransactionStatus(
      variables: UpdateTransactionStatusMutationVariables
    ): Promise<UpdateTransactionStatusMutation> {
      return withWrapper(() =>
        client.request<UpdateTransactionStatusMutation>(
          print(UpdateTransactionStatusDocument),
          variables
        )
      )
    },
