...
export type CreateUserMutation = (
  ...
  & { insert_user_one?: Maybe<(
    { __typename?: 'user' }
    & Pick<User, 'id' | 'user_type' | 'first_name' | 'last_name' | 'created_at' | 'email' | 'phone' | 'demographic_info' | 'account_details'>
  )> }
);
...
export type GetAccountDetailsQuery = (
  ...
  & { user?: Maybe<(
    { __typename?: 'user' }
    & Pick<User, 'account_details' | 'kyc_approved'>
  )> }
);
...
export type GetAllUsersQuery = (
  ...
  & { user: Array<(
    { __typename?: 'user' }
    & Pick<User, 'id' | 'email' | 'first_name' | 'last_name' | 'user_type' | 'balance' | 'kyc_approved' | 'onboarded' | 'demographic_info' | 'account_details'>
    & { loan_requests: Array<(
      { __typename?: 'loan_request' }
      & Pick<Loan_Request, 'amount' | 'purpose' | 'state'>
    )>, loans: Array<(
      { __typename?: 'loan' }
      & Pick<Loan, 'state' | 'principal'>
    )> }
  )> }
);
...
export type GetUserByEmailQuery = (
  ...
  & { user: Array<(
    { __typename?: 'user' }
    & Pick<User, 'id' | 'email' | 'first_name' | 'last_name' | 'demographic_info' | 'kyc_approved' | 'onboarded' | 'phone' | 'user_type' | 'balance' | 'created_at' | 'account_details'>
    & { approvedBorrowers: Array<(
      { __typename?: 'credit_line' }
      & Pick<Credit_Line, 'borrower_id'>
    )>, loan_requests: Array<(
      { __typename?: 'loan_request' }
...
export type ApproveKycMutation = (
  { __typename?: 'mutation_root' }
  & { user?: Maybe<(
    { __typename?: 'user' }
    & Pick<User, 'id' | 'kyc_approved'>
  )> }
);
...
export type LogUpdateMutation = (
  { __typename?: 'mutation_root' }
  & { insert_update_log_one?: Maybe<(
    { __typename?: 'update_log' }
    & Pick<Update_Log, 'update_id' | 'type'>
  )> }
);
...
export type GetAllActionsQuery = (
  ...
  & { scenario_actions: Array<(
    { __typename?: 'scenario_actions' }
    & Pick<Scenario_Actions, 'id' | 'action_type' | 'payload'>
  )> }
);
...
export type GetUpdatesQuery = (
  ...
  & { updates: Array<(
    { __typename?: 'update_log' }
    & Pick<Update_Log, 'update_id' | 'type' | 'updated_at' | 'new_principal_remain' | 'new_interest_paid' | 'new_interest_accrued' | 'repayment_id' | 'new_next_payment_amount' | 'new_next_payment_due_date' | 'new_state'>
  )> }
);
...
export type InsertEventMutation = (
  ...
  & { insert_events_one?: Maybe<(
    { __typename?: 'events' }
    & Pick<Events, 'id' | 'event_type' | 'headers' | 'data'>
    & { user?: Maybe<(
      { __typename?: 'user' }
      & Pick<User, 'id' | 'email'>
    )> }
...
export type InsertScenarioActionMutation = (
  { __typename?: 'mutation_root' }
...
export type ApproveBorrowerMutation = (
  { __typename?: 'mutation_root' }
  & { insert_credit_line_one?: Maybe<(
    { __typename?: 'credit_line' }
    & Pick<Credit_Line, 'borrower_id' | 'investor_id'>
  )> }
);
...
export type FundLoanRequestMutationVariables = Exact<{
  ...
  lenderAmounts: Array<Lender_Amount_Insert_Input> | Lender_Amount_Insert_Input;
}>;


export type FundLoanRequestMutation = (
  { __typename?: 'mutation_root' }
  & { loanRequest?: Maybe<(
    { __typename?: 'loan_request' }
...
export type GetBorrowersQuery = (
  ...
  & { borrowers: Array<(
    ...
    & { loan_requests: Array<(
      { __typename?: 'loan_request' }
      & Pick<Loan_Request, 'amount' | 'state' | 'request_id' | 'purpose'>
    )> }
  )> }
);
...
export type GetLoanRequestsQuery = (
  ...
  & { loanRequests: Array<(
    { __typename?: 'loan_request' }
    & Pick<Loan_Request, 'request_id' | 'amount' | 'state'>
    & { borrowerInfo: (
      { __typename?: 'user' }
      & Pick<User, 'id' | 'demographic_info'>
    ) }
  )> }
);
...
export type GetLoanStateQuery = (
  { __typename?: 'query_root' }
  & { loan?: Maybe<(
    { __typename?: 'loan' }
    & Pick<Loan, 'state' | 'principal_remaining' | 'principal_overdue' | 'interest_accrued' | 'interest_paid' | 'next_payment_amount' | 'next_payment_due_date'>
  )> }
);
...
export type GetOpenRequestsQuery = (
  { __typename?: 'query_root' }
  & { activeRequests: Array<(
    { __typename?: 'loan_request' }
    & Pick<Loan_Request, 'request_id' | 'purpose' | 'amount'>
    & { creditors: (
      { __typename?: 'user' }
      & { approved: Array<(
        { __typename?: 'credit_line' }
        & Pick<Credit_Line, 'investor_id'>
        & { account: (
          { __typename?: 'user' }
          & Pick<User, 'balance'>
        ) }
...
export type RegisterRepaymentMutation = (
  { __typename?: 'mutation_root' }
  & { loan?: Maybe<(
    { __typename?: 'loan' }
...
export type ResetDbMutation = (
  ...
  & { delete_update_log?: Maybe<(
    { __typename?: 'update_log_mutation_response' }
    & Pick<Update_Log_Mutation_Response, 'affected_rows'>
  )>, delete_credit_line?: Maybe<(
    { __typename?: 'credit_line_mutation_response' }
    & Pick<Credit_Line_Mutation_Response, 'affected_rows'>
  )>, delete_repayment?: Maybe<(
    { __typename?: 'repayment_mutation_response' }
    & Pick<Repayment_Mutation_Response, 'affected_rows'>
  )>, delete_lender_amount?: Maybe<(
    { __typename?: 'lender_amount_mutation_response' }
    & Pick<Lender_Amount_Mutation_Response, 'affected_rows'>
  )>, delete_loan_request?: Maybe<(
    { __typename?: 'loan_request_mutation_response' }
    & Pick<Loan_Request_Mutation_Response, 'affected_rows'>
  )>, delete_loan?: Maybe<(
    { __typename?: 'loan_mutation_response' }
    & Pick<Loan_Mutation_Response, 'affected_rows'>
  )>, delete_events?: Maybe<(
    { __typename?: 'events_mutation_response' }
    ...
    { __typename?: 'scenario_actions_mutation_response' }
    & Pick<Scenario_Actions_Mutation_Response, 'affected_rows'>
  )> }
);
...
export type ResetLoansMutation = (
  { __typename?: 'mutation_root' }
  & { delete_lender_amount?: Maybe<(
    { __typename?: 'lender_amount_mutation_response' }
    & Pick<Lender_Amount_Mutation_Response, 'affected_rows'>
...
export type ResetRepaymentsMutation = (
  { __typename?: 'mutation_root' }
  & { delete_repayment?: Maybe<(
    { __typename?: 'repayment_mutation_response' }
    & Pick<Repayment_Mutation_Response, 'affected_rows'>
...
export type ResetRequestsMutation = (
  { __typename?: 'mutation_root' }
  & { delete_loan_request?: Maybe<(
    { __typename?: 'loan_request_mutation_response' }
    & Pick<Loan_Request_Mutation_Response, 'affected_rows'>
...
export const CreateUserDocument = gql`
  ...
  insert_user_one(
    object: $user
    on_conflict: {constraint: user_email_key, update_columns: [first_name, phone, onboarded]}
  ) {
    id
    user_type
    first_name
...
export const UpdateUserBalanceDocument = gql`
  ...
  user: update_user_by_pk(pk_columns: {id: $userId}, _set: {balance: $newBalance}) {
    balance
  }
}
    `;
...
export const FundLoanRequestDocument = gql`
    mutation FundLoanRequest($requestId: uuid!, $loan: loan_insert_input!, $lenderAmounts: [lender_amount_insert_input!]!) {
...
export const GetBorrowersDocument = gql`
    query GetBorrowers {
  borrowers: user(
    where: {_and: [{user_type: {_eq: "borrower"}}, {kyc_approved: {_eq: true}}]}
  ) {
    first_name
    last_name
    id
...
export const RegisterRepaymentDocument = gql`
    mutation RegisterRepayment($loanId: uuid!, $repayment: repayment_insert_input!, $newLoanState: loan_state_enum, $newPrincipalRemaining: float8, $newPrincipalOverdue: float8, $newInterestAccrued: float8, $newInterestPaid: float8, $newNextPaymentAmount: float8, $newNextPaymentDueDate: timestamptz, $updateLog: update_log_insert_input!) {
  loan: update_loan_by_pk(
    pk_columns: {loan_id: $loanId}
    _set: {state: $newLoanState, principal_remaining: $newPrincipalRemaining, principal_overdue: $newPrincipalOverdue, interest_accrued: $newInterestAccrued, interest_paid: $newInterestPaid, next_payment_amount: $newNextPaymentAmount, next_payment_due_date: $newNextPaymentDueDate}
  ) {
    state
    principal_remaining
  }
...
export const RemoveBorrowerApprovalDocument = gql`
  ...
  delete_credit_line_by_pk(borrower_id: $borrower_id, investor_id: $investor_id) {
    borrower_id
    investor_id
  }
}
...
export const UpdateLoanDocument = gql`
    mutation UpdateLoan($loanId: uuid!, $newLoanState: loan_state_enum, $newPrincipalRemaining: float8, $newPrincipalOverdue: float8, $newInterestAccrued: float8, $newInterestPaid: float8, $newNextPaymentAmount: float8, $newNextPaymentDueDate: timestamptz) {
  loan: update_loan_by_pk(
    pk_columns: {loan_id: $loanId}
    _set: {state: $newLoanState, principal_remaining: $newPrincipalRemaining, principal_overdue: $newPrincipalOverdue, interest_accrued: $newInterestAccrued, interest_paid: $newInterestPaid, next_payment_amount: $newNextPaymentAmount, next_payment_due_date: $newNextPaymentDueDate}
  ) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetAccountDetails(variables: GetAccountDetailsQueryVariables): Promise<GetAccountDetailsQuery> {
      return withWrapper(() => client.request<GetAccountDetailsQuery>(print(GetAccountDetailsDocument), variables));
    },
    ...
    ApproveKYC(variables: ApproveKycMutationVariables): Promise<ApproveKycMutation> {
      return withWrapper(() => client.request<ApproveKycMutation>(print(ApproveKycDocument), variables));
    },
    UpdateAccountDetails(variables: UpdateAccountDetailsMutationVariables): Promise<UpdateAccountDetailsMutation> {
      return withWrapper(() => client.request<UpdateAccountDetailsMutation>(print(UpdateAccountDetailsDocument), variables));
    },
    UpdateUserBalance(variables: UpdateUserBalanceMutationVariables): Promise<UpdateUserBalanceMutation> {
      return withWrapper(() => client.request<UpdateUserBalanceMutation>(print(UpdateUserBalanceDocument), variables));
    },
    LogUpdate(variables: LogUpdateMutationVariables): Promise<LogUpdateMutation> {
      return withWrapper(() => client.request<LogUpdateMutation>(print(LogUpdateDocument), variables));
    },
    GetAllActions(variables?: GetAllActionsQueryVariables): Promise<GetAllActionsQuery> {
      return withWrapper(() => client.request<GetAllActionsQuery>(print(GetAllActionsDocument), variables));
    },
    GetUpdates(variables?: GetUpdatesQueryVariables): Promise<GetUpdatesQuery> {
      return withWrapper(() => client.request<GetUpdatesQuery>(print(GetUpdatesDocument), variables));
    },
    ...
    InsertScenarioAction(variables: InsertScenarioActionMutationVariables): Promise<InsertScenarioActionMutation> {
      return withWrapper(() => client.request<InsertScenarioActionMutation>(print(InsertScenarioActionDocument), variables));
    },
    ApproveBorrower(variables: ApproveBorrowerMutationVariables): Promise<ApproveBorrowerMutation> {
      return withWrapper(() => client.request<ApproveBorrowerMutation>(print(ApproveBorrowerDocument), variables));
    },
    ...
    FundLoanRequest(variables: FundLoanRequestMutationVariables): Promise<FundLoanRequestMutation> {
      return withWrapper(() => client.request<FundLoanRequestMutation>(print(FundLoanRequestDocument), variables));
    },
    GetBorrowers(variables?: GetBorrowersQueryVariables): Promise<GetBorrowersQuery> {
      return withWrapper(() => client.request<GetBorrowersQuery>(print(GetBorrowersDocument), variables));
    },
    GetLiveLoans(variables?: GetLiveLoansQueryVariables): Promise<GetLiveLoansQuery> {
      return withWrapper(() => client.request<GetLiveLoansQuery>(print(GetLiveLoansDocument), variables));
    },
    ...
    GetLoanRequests(variables?: GetLoanRequestsQueryVariables): Promise<GetLoanRequestsQuery> {
      return withWrapper(() => client.request<GetLoanRequestsQuery>(print(GetLoanRequestsDocument), variables));
    },
    GetLoanState(variables: GetLoanStateQueryVariables): Promise<GetLoanStateQuery> {
      return withWrapper(() => client.request<GetLoanStateQuery>(print(GetLoanStateDocument), variables));
    },
    GetLoan(variables: GetLoanQueryVariables): Promise<GetLoanQuery> {
      return withWrapper(() => client.request<GetLoanQuery>(print(GetLoanDocument), variables));
    },
    GetOpenRequests(variables?: GetOpenRequestsQueryVariables): Promise<GetOpenRequestsQuery> {
      return withWrapper(() => client.request<GetOpenRequestsQuery>(print(GetOpenRequestsDocument), variables));
    },
    RegisterRepayment(variables: RegisterRepaymentMutationVariables): Promise<RegisterRepaymentMutation> {
      return withWrapper(() => client.request<RegisterRepaymentMutation>(print(RegisterRepaymentDocument), variables));
    },
    RemoveBorrowerApproval(variables: RemoveBorrowerApprovalMutationVariables): Promise<RemoveBorrowerApprovalMutation> {
      return withWrapper(() => client.request<RemoveBorrowerApprovalMutation>(print(RemoveBorrowerApprovalDocument), variables));
    },
    UpdateLoan(variables: UpdateLoanMutationVariables): Promise<UpdateLoanMutation> {
      return withWrapper(() => client.request<UpdateLoanMutation>(print(UpdateLoanDocument), variables));
    },
    ...
    ResetLoans(variables?: ResetLoansMutationVariables): Promise<ResetLoansMutation> {
      return withWrapper(() => client.request<ResetLoansMutation>(print(ResetLoansDocument), variables));
    },
    ResetRepayments(variables?: ResetRepaymentsMutationVariables): Promise<ResetRepaymentsMutation> {
      return withWrapper(() => client.request<ResetRepaymentsMutation>(print(ResetRepaymentsDocument), variables));
    },
    ResetRequests(variables?: ResetRequestsMutationVariables): Promise<ResetRequestsMutation> {
      return withWrapper(() => client.request<ResetRequestsMutation>(print(ResetRequestsDocument), variables));
    }
  };
}
